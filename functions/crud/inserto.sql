...
END;
$$;
-- SELECT ADD_CLIENTE('JOÃO', 'JOAO@EMAIL.COM', '11999999999', TRUE);

-- FUNÇÃO PARA INSERIR UM ENDEREÇO
CREATE OR REPLACE FUNCTION ADD_ENDERECO(
    COMPLEMENTO TEXT,
    NUMERO TEXT,
    BAIRRO TEXT,
    RUA TEXT,
...
AS $$
DECLARE
    COLUNAS TEXT := 'COMPLEMENTO, NUMERO, BAIRRO, RUA, CEP';
    VALORES TEXT;
BEGIN
...
CREATE OR REPLACE FUNCTION ADD_ATENDENTE(
    NOME TEXT,
    CPF TEXT,
    EMAIL TEXT,
    ATIVO BOOLEAN
...
END;
$$;
-- SELECT ADD_ATENDENTE('ROBERTO', '08790882319', 'ROBERTO@EMAIL.COM', TRUE);

-- FUNÇÃO PARA INSERIR UM ENTREGADOR
CREATE OR REPLACE FUNCTION ADD_ENTREGADOR(
    NOME TEXT,
    CPF TEXT,
    TELEFONE TEXT,
    ATIVO BOOLEAN
...
END;
$$;
-- SELECT ADD_ENTREGADOR('ENZO', '12345678999', '12345678', TRUE);

-- FUNÇÃO PARA INSERIR UM FORNECEDOR
CREATE OR REPLACE FUNCTION ADD_FORNECEDOR(
    NOME TEXT,
    EMAIL TEXT,
    TELEFONE TEXT,
    ATIVO BOOLEAN
...
END;
$$;
-- SELECT ADD_FORNECEDOR('FORNECEDOR 1', 'forn@gmail.com', '12345678', TRUE);
...
AS $$
DECLARE
    COLUNAS TEXT := 'NOME, DESCRICAO, VALOR_UNITARIO';
    VALORES TEXT;
BEGIN
    VALORES := QUOTE_LITERAL(NOME) || ', ' ||
...
AS $$
DECLARE
    COLUNAS TEXT := 'NOME, UNIDADE_MEDIDA, QTD_ESTOQUE';
    VALORES TEXT;
BEGIN
    VALORES := QUOTE_LITERAL(NOME) || ', ' ||
...
CREATE OR REPLACE FUNCTION ADD_TIPO_PAGAMENTO(
    NOME TEXT
)
RETURNS VOID
LANGUAGE PLPGSQL
